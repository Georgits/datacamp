...
count_by_weekday1 = pd.pivot_table(users, index = 'weekday', columns='city', aggfunc='count')
# Print count_by_weekday
print(count_by_weekday1)
# Replace 'aggfunc='count'' with 'aggfunc=len': count_by_weekday2
count_by_weekday2 = pd.pivot_table(users, index = 'weekday', columns='city', aggfunc=len)
...
# calculates the mean survival rates on the 'C' deck:
